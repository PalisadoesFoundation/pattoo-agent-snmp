...
Below is the workflow for having your contribution accepted into the ``pattoo-agent-snmp`` repository.
...
#. Add the original project as a remote (git remote add upstream https://github.com/PalisadoesFoundation/pattoo-agent-snmp, check with: git remote -v)
