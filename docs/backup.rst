...
#. The ``pattoo-agent-snmp`` directory which contains your source code.
...
It's important to follow these steps in this order when restoring ``pattoo-agent-snmp`` after a disaster.
...
#. Restore ``pattoo-agent-snmp`` directory which contains your source code.
