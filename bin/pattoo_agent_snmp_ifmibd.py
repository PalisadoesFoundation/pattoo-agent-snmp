...
_EXPECTED = '{0}pattoo-agent-snmp{0}bin'.format(os.sep)
...
from pattoo_agent_snmp import PATTOO_AGENT_SNMP_IFMIBD
from pattoo_agent_snmp.ifmib import collector
from pattoo_agent_snmp.configuration import ConfigSNMPIfMIB as Config
