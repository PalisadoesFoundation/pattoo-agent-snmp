#!/usr/bin/env python3
"""Script to test all the pattoo-agent-snmp unittests.
...
_EXPECTED = '{0}pattoo-agent-snmp{0}tests{0}bin'.format(os.sep)
...
def main():
    """Test all the pattoo-agent-snmp modules with unittests.
...
def run_script(cli_string):
    ...
    pattoo_returncode = ('----- pattoo-agent-snmp Return Code '
                         '----------------------------------------')
    pattoo_stdoutdata = ('----- pattoo-agent-snmp Test Output '
                         '----------------------------------------')
    pattoo_stderrdata = ('----- pattoo-agent-snmp Test Error '
                         '-----------------------------------------')
